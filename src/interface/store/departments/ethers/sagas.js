...
const walletSelection = (network, provider) => {
  switch(idx(network, _=>_.wallet)) {
    case 'testing':
      const wallet = new ethers.Wallet("0x52bd623b260c6c159290cfc6c72000d05e974b5a98ecc098d19fbf7289dd9d6e");
            wallet.provider = provider
      return wallet
    case 'metamask':
      return new MetamaskSigner(window.web3, provider);
      default:
...
export function * providerJsonRpc ({payload, metadata}) {
  try {
      ...
      window.ethereum.providers.json = provider
...
export function * contractDeploy ({payload, metadata}) {
  try {
    ...
    // var wallet = new ethers.Wallet("0x52bd623b260c6c159290cfc6c72000d05e974b5a98ecc098d19fbf7289dd9d6e");
    // wallet.provider = provider
